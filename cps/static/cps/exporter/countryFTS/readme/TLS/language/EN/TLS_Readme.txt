...
Indicators are organized into several thematic tabs in this file.  All are annual indicators with the exception of the "5-year indicators" tab which groups the small set of indicators with 5-year periods.

Field Definitions
Attribute ID : A unique identifier within HDX for an attribute of an entity (typically a country or crisis).  Attributes are information that changes rarely if at all, like country name, currency code, etc.  It is provided here to assist those who may be working with the HDX API to extract data from our databases.
Attribute Name : A human readable name for an attribute of an entity (typically a country or crisis). Attributes are information that changes rarely if at all, like country name, currency code, etc.  
...
COUNTRY OVERVIEW
CAP Amount Required (Revised) : 1.79660556E8
CAP Amount Received : 1.25586657E8
Cross-Appeal: Amount Requested (Original) : 1.99046099E8
Cross-Appeal: Amount Requested (Revised) : 1.79660556E8
Cross-Appeal: Amount Received : 1.25586657E8
Cross-Appeal: Amount Received By NGOs : 1300000.0
Cross-Appeal: Amount Received By Private Orgs. & Foundations : 0.0
Cross-Appeal: Amount Received By UN Agencies : 1.24286657E8
CERF Total Allocations : 0.0
CERF Country Allocation as Fraction of CERF Global Allocation : 0.0
CERF Country Allocation as Fraction of Total Country Funding : 0.0
ERF Total Allocations : 0.0
ERF Country Allocation as Fraction of ERF Global Allocation : 0.0
ERF Country Allocation as Fraction of Total Country Funding : 0.0
CHF Total Allocations : 0.0
CHF Country Allocation as Fraction of CHF Global Allocation : 0.0
CHF Country Allocation as Fraction of Total Country Funding : 0.0
Total Country Pooled Fund Allocations : 0.0
Total Country Humanitarian Funding Received : 1.80132946E8
