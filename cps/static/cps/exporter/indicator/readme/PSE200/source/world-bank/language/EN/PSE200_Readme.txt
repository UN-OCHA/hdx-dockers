...
Indicator ID : PSE200
Indicator name : Inflation, consumer prices 
Source dataset : World Bank
Units : Percentage
Data summary : Inflation, consumer prices
More info : http://data.worldbank.org/indicator/FP.CPI.TOTL.ZG
...
HDX methodology : Inflation as measured by the consumer price index reflects the annual percentage change in the cost to the average consumer of acquiring a basket of goods and services that may be fixed or changed at specified intervals, such as yearly. The Laspeyres formula is generally used.
