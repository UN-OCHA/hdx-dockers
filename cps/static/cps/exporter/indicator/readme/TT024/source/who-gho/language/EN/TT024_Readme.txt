...
Indicator ID : TT024
Indicator name : Percentage of children less than 5 stunted (Both sexes)
Source dataset : WHO Global Health Observatory
Units : Percentage
Data summary : Percentage of stunting (height-for-age less than -2 standard deviations of the WHO Child Growth Standards median) among children aged 0-5 years
More info : http://apps.who.int/gho/indicatorregistry/App_Main/view_indicator.aspx?iid=72
...
HDX methodology : Percentage of children aged <5 years stunted for age = (Number of children aged 0-5 years that fall below minus two standard deviations from the median height-for-age of the WHO Child Growth Standards / Total number of children aged 0-5 years that were measured) * 100.
