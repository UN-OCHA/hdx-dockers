...
Indicator ID : PVL030
Indicator name : Roads, total network 
Source dataset : World Bank
Units : km
Data summary : Roads, total network
More info : http://data.worldbank.org/indicator/IS.ROD.TOTL.KM
...
HDX methodology : Total road network includes motorways, highways, and main or national roads, secondary or regional roads, and all other roads in a country. A motorway is a road designed and built for motor traffic that separates the traffic flowing in opposite directions.
