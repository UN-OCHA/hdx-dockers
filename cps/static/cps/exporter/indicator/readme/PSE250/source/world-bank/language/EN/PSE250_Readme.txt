...
Indicator ID : PSE250
Indicator name : Net ODA received per capita 
Source dataset : World Bank
Units : Current International US$
Data summary : Net ODA received per capita in current US$
More info : http://data.worldbank.org/indicator/DT.ODA.ODAT.PC.ZS
