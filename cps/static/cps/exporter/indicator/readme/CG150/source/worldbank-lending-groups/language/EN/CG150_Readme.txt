...
Indicator ID : CG150
Indicator name : Income Category
Source dataset : World Bank
Units : Text
Data summary : Income category
More info : http://data.worldbank.org/about/country-classifications
...
HDX methodology : For operational and analytical purposes, the World Bank’s main criterion for classifying economies is gross national income (GNI) per capita. In previous editions of our publications, this term was referred to as gross national product, or GNP. (Learn more about this change in terminology.) Based on its GNI per capita, every economy is classified as low income, middle income (subdivided into lower middle and upper middle), or high income. Other analytical groups based on geographic regions are also used.
