...
Indicator ID : PVH200
Indicator name : Crude death rate by major area, region and country, 1950-2100
Source dataset : World Population Prospects (2012)
Units : Deaths per 1,000 population
Data summary : Number of deaths over a given period divided by the person-years lived by the population over that period. It is expressed as average annual number of deaths per 1,000 population.
More info : http://esa.un.org/wpp/Excel-Data/mortality.htm
...
HDX methodology : Number of deaths over a given period divided by the person-years lived by the population over that period. It is expressed as average annual number of deaths per 1,000 population.
