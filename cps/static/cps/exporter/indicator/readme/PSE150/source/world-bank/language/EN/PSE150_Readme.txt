...
Indicator ID : PSE150
Indicator name : Age dependency ratio, young 
Source dataset : World Bank
Units : Percentage
Data summary : Age dependency ratio, young, is the ratio of younger dependents (people younger than 15) to the working-age population(those ages 15-64).
More info : http://data.worldbank.org/indicator/SP.POP.DPND.YG
