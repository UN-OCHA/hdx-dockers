...
Indicator ID : PSE140
Indicator name : Age dependency ratio, old 
Source dataset : World Bank
Units : Percentage
Data summary : Age dependency ratio, old, is the ratio of older dependents (people older than 64) to the working-age population (those ages 15-64).
More info : http://data.worldbank.org/indicator/SP.POP.DPND.OL
