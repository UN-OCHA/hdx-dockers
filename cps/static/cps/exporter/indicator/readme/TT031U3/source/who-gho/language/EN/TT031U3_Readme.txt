...
Indicator ID : TT031U3
Indicator name : Antenatal care coverage - at least one visit in the three years preceding the study (Urban)
Source dataset : WHO Global Health Observatory
Units : Percentage
Data summary : The percentage of women aged 15-49 with a live birth in a given time period that received antenatal care provided by skilled health personnel (doctors, nurses, or midwives) at least once during pregnancy.
More info : http://apps.who.int/gho/indicatorregistry/App_Main/view_indicator.aspx?iid=81
...
HDX methodology : UNICEF and the WHO produce regional and global estimates. These are based on population-weighted averages weighted by the total number of births. These estimates are presented only if available data cover at least 50% of total births in the regional or global groupings.
