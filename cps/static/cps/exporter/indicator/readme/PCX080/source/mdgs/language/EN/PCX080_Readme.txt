...
Indicator ID : PCX080
Indicator name : Fixed telephone lines per 100 inhabitants
Source dataset : UN DESA Millennium Development Goals
Units : Fixed telephone lines per 100 people
Data summary : Fixed telephone lines per 100 inhabitants.
More info : http://data.worldbank.org/indicator/IT.MLT.MAIN.P2
...
HDX methodology : Telephone lines are fixed telephone lines that connect a subscriber's terminal equipment to the public switched telephone network and that have a port on a telephone exchange. Integrated services digital network channels ands fixed wireless subscribers are included.
