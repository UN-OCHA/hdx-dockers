...
Indicator ID : PCH110
Indicator name : Number of infant deaths
Source dataset : World Bank
Units : Deaths
Data summary : Number of infants dying before reaching one year of age
More info : http://data.worldbank.org/indicator/SP.DYN.IMRT.IN
...
HDX methodology : Infant mortality rate (IMR) is the number of deaths of children less than one year of age per 1000 live births. The rate for a given region is the number of children dying under one year of age, divided by the number of live births during the year, multiplied by 1,000.
