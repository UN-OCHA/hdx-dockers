...
Indicator ID : TT010
Indicator name : Total number of reported deaths due to malaria
Source dataset : WHO Global Health Observatory
Units : Deaths
Data summary : The sum deaths from malaria from confirmed and probable cases.
More info : http://apps.who.int/gho/indicatorregistry/App_Main/view_indicator.aspx?iid=2967
...
HDX methodology : WHO compiles data on reported deaths from malaria, submitted by the national malaria control programmes (NMCPs).
