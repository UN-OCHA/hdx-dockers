...
Indicator ID : TT020
Indicator name : Cholera case fatality rate
Source dataset : WHO Global Health Observatory
Units : Percentage
Data summary : Proportion of cholera cases which are fatal within a specified time.
More info : http://apps.who.int/gho/indicatorregistry/App_Main/view_indicator.aspx?iid=2445
...
HDX methodology : WHO calculates case fatality rates based on the numbers of cases and deaths as reported by national authorities (Ministries of Health).
