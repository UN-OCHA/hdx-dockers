...
Indicator ID : PCH100
Indicator name : Percentage of children one year old immunized against measles
Source dataset : UN DESA Millennium Development Goals
Units : Percentage
Data summary : Percentage of children one year old immunized against measles
More info : More information, including rationale, interpretation, sources, data collection, comments, limitation, and gender equality issues can be found at http://mdgs.un.org/unsd/mi/wiki/4-3-Proportion-of-1-year-old-children-immunised-against-measles.ashx
...
HDX methodology : The proportion of 1 year-old children immunized against measles is the proportion of children under one year of age who have received at least one dose of measles-containing vaccine. 
