...
Indicator ID : TT013U
Indicator name : Total number of children with fever who received treatment with antimalarial (Urban)
Source dataset : WHO Global Health Observatory
Units : People
Data summary : Percentage of children aged < 5 years with fever in malaria-risk areas being treated with effective antimalarial drugs.
More info : http://apps.who.int/gho/indicatorregistry/App_Main/view_indicator.aspx?iid=14
...
HDX methodology : Data from nationally-representative household surveys, including Multiple Indicator Cluster Surveys (MICS), Demographic Health Surveys (DHS) and Malaria Indicator Surveys (MIS), are compiled in the UNICEF global databases.
