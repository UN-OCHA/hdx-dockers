...
Indicator ID : TT021
Indicator name : Total number of influenza viruses detected
Source dataset : WHO Global Atlas
Units : Viruses
Data summary : Total number of influenza viruses detected
More info : http://gamapserver.who.int/gareports/Default.aspx?ReportNo=6
...
HDX methodology : The data are provided remotely by National Influenza Centres (NICs) of the Global Influenza Surveillance and Response System (GISRS) and other national influenza reference laboratories collaborating actively with GISRS, or are uploaded from WHO regional databases.
