...
Indicator ID : CG070
Indicator name : ISO Country alpha-3-code
Source dataset : UN Multilingual Terminology Database (UNTERM)
Units : Text
Data summary : ISO Country alpha-3-code.
...
HDX methodology : List of two letter codes (ISO alpha-2) and the three letter codes (ISO alpha-3) as well as the United Nations used numerical code M49 for countries, dependencies, and other areas.
