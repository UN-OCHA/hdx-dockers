...
Indicator ID : TT035
Indicator name : Population aged 15-24 years with comprehensive correct knowledge of HIV/AIDS (%)
Source dataset : WHO Global Health Observatory
Units : Percentage
Data summary : Percentage of young people aged 15–24 who both correctly identify ways of preventing the sexual transmission of HIV and who reject major misconceptions about HIV transmission
More info : http://apps.who.int/gho/indicatorregistry/App_Main/view_indicator.aspx?iid=21
...
HDX methodology : Estimates derived from household surveys (DHS, MICS) are presented here, as compiled and reported by UNAIDS in the 2008 Report on the Global AIDS epidemics, Annex 2 (UNAIDS, 2008).
