...
Indicator ID : CH100
Indicator name : Total cost of damage done by disasters
Source dataset : EM-DAT
Units : US$
Data summary : Total cost of damage done by disasters
...
HDX methodology : Several institutions have developed methodologies to quantify these losses in their specific domain. However, there is no standard procedure to determine a global figure for economic impact. Estimated damage are given (000’) US$.
