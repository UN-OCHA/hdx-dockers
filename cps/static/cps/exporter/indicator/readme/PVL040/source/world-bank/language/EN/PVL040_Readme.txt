...
Indicator ID : PVL040
Indicator name : Rail lines 
Source dataset : World Bank
Units : km
Data summary : Rail lines
More info : http://data.worldbank.org/indicator/IS.RRS.TOTL.KM
...
HDX methodology : Rail lines are the length of railway route available for train service, irrespective of the number of parallel tracks.
