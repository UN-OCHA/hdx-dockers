...
Indicator ID : PVW010
Indicator name : Proportion of the population using improved drinking water sources
Source dataset : UN DESA Millennium Development Goals
Units : Percentage
Data summary : Proportion of the population using improved drinking water sources
More info : http://unstats.un.org/unsd/mdg/Metadata.aspx?IndicatorId=0&SeriesId=665
