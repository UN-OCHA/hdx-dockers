...
COUNTRY OVERVIEW
Formal Name : the Republic of the Marshall Islands
Short Name : Marshall Islands (the)
m49-num : 584
ISO Country alpha-3-code : MHL
Capital City : Majuro
...
Country code (m49-name) : Marshall Islands
Country code (ISO Country alpha-2-code) : MH
